import { type Digit, digit } from '../parser-combinator/char';
...
export type DateFunc = Parser<[Digit, Digit, Digit, Digit, '-', Digit, Digit, '-', Digit, Digit]>;
export const date = map(
  cat([rep(digit, 4, 4), CHAR_MINUS, rep(digit, 2, 2), CHAR_MINUS, rep(digit, 2, 2)]),
  ([y, , m, , d]) => {
